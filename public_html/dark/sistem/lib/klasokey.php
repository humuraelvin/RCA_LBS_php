<?php
	 ...
	 * @file   : KlasOkey.v2.php

	 ========== KlasGamingNetwork v2 =========
	...
	*/
	...
	class KlasOkey {
		...
		private $apiUrl = 'http://apiv2.klasgaming.com';



		function __construct() {

			$this->MerchantId = OKEY_MERCHANT_ID;

			$this->PrivateKey = OKEY_PRIVATE_KEY;
		...
		*/
		...
		public function marinRequest(array $data, $post = true) {

			$ch = curl_init();

			curl_setopt($ch, CURLOPT_URL, $this->marinUrl . '?' . http_build_query($data) . '&hash=' . $this->hashSig($data['method'], $data));
