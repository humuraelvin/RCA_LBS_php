<div class="left-container nano-content account-left-bar" tabindex="0" style="right: -17px;">
    ...
    <ul class="list-unstyled sport-menu event-menu acc-menu no-padding">
        ...
        <li><a href="/myaccount/deposit" style="text-align:left;"><i class="icon-transactions"></i>Para Yatır</a>
        <!--- <li><a href="https://pay.iyzibet2.com/para-yatir?id=<?php echo $bilgi['id']; ?>" target="_blank" style="text-align:left;"><i class="icon-wallet"></i>Para Yatır</a></li> --->
