        ...
        $.ajax({
            ...
            success:function(response){
                if (response.code == "1") {
                    ...
                    $("#liveLoaders").hide();
                    $(".center-container").append('<iframe scrolling="no" frameborder="0" border="0" width="100%" height="800px" src="https://hogaming.iyzibet.com/login/visitor/checkLoginGI.jsp?ticketId='+ response.token +'&gameType=0000000000000004&lang=en&version=v4"></iframe>')
                }
            }
        });
    }
