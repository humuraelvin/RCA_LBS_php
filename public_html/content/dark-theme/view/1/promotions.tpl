...
<section id="main" class="" style="margin-top: 20px;">
    <div class="container">
                        ...
                        {foreach from="$promosyonlar" item="promos" key="a"}
                            <div class="col-sm-4 promotions-banner" >
                                <a href="#{php}echo $promos->seourl;{/php}" class="promo " >
                                    <img alt="" class="img-responsive" src="{php}echo $promos->resim;{/php}">
                                </a>
                            </div>
                        {/foreach} 
                        </div>
...
{foreach from="$promosyonlar" item="promos" key="a"}
<div class="remodal" data-remodal-id="{php}echo $promos->seourl;{/php}" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
