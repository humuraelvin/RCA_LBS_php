...
<section id="main" class="" style="">
    <div class="container">
  	...
  	<form action="https://stage.iyzibet2.com/papara/islem.php?id={$bilgi["telefon"]}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="adsoyad" value="{$bilgi["name"]}" type="text" readonly="">
                                                </div>
                                            </div>
 <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="telefon" value="{$bilgi["telefon"]}" type="text" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label" for="amount">Tutar</label>
                                                     div class="input-group">
                                                        <input class="form-control" name="tutar" data-validation="acg" type="text" onkeypress="numberControl(event)">
                                                        <span class="input-group-addon">TL</span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel-footer">
                                        <button class="btn btn-primary btn-lg btn-sm-wide pull-right btn-icon submit-btn" href="https://stage.iyzibet2.com/1/index.php?id=3">
                                            PARA YATIR
                                            <i class="icon-arrow-right"></i>
                                        </button>
                                        <div class="clearfix"></div>
