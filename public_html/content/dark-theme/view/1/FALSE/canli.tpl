    ...
    $.ajax({
        ...
        success: function( c ) {
            ...
            $.each( c.list, function(i, val) {
                ...
                // ok
                $(".bultenler").append('<div id="liveSportMenux" class="megadiv ' + collapsed +  '  " data-toggle="collapse" sport-id="'+ val[Object.keys(val)[0]].sport_id +'" onclick="resize();" data-target="#sport-'+ val[Object.keys(val)[0]].sport_id +'">\
                <h4 aria-expanded="true">\
                <div class="leftdiv"> <img src="/images/sports-icon/'+ Spor +'.png"></div>\
                <div class="left-text">'+ Spor +'</div>\
                <div class="rightdiv"><span id="b1">'+ Object.keys(val).length +'</span></div>\
                </h4>\
                </div>\
                <div class="collapse ' + colin +  ' " sport-id="'+ val[Object.keys(val)[0]].sport_id +'" id="sport-'+ val[Object.keys(val)[0]].sport_id +'"></div>\
                ');
