...
<section id="main" class="sportsbook_padding newCasino">
    ...
    <div id="large-slider" class="carousel slide mobile-casino" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <a href="" target="">
                <img alt="" src="{php}echo $banner->path;{/php}">
            </a>
            ...
            <div class="container">
                <div class="collapse navbar-collapse propogate" id="casino-collapse-menu" style="max-height: 1233px;">
                    <ul class="nav navbar-nav main-navbar submenu  submenu-casino">
                        <li><a href="#Slot Machines" %="">Slot Machhines</a></li>
                    ...
                    <div class="container">
                        <div id="main-center">
                            <div class="center-container ">
                                {php}foreach ($list as $key => $games) { {/php}
                                <h2 id="{php}echo $key;{/php}"> {php}echo $key;{/php} <a href=""> Game <b>{php}echo count($games);{/php}</b> <i class="icon-arrow-right"></i> </a> </h2>

                                <div class="row">
                                    {php}foreach ($games as $gamekey => $game) { {/php}
                                    <div class="col-md-3 casino-image" onclick="openHogaming({$gamekey})">
                                        <img src="{php}echo $game['game_image'];{/php}">
                                        <div class="fullgamename">{php}echo $game['game_name'];{/php}</div>
