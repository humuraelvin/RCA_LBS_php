                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" readonly="">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php if(isset($bilgi["dt"])) { echo $bilgi["dt"];}?>" readonly="">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php  echo substr($bilgi["tc"],0,3); ?>*******" readonly="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row bwt-details">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php  echo substr($bilgi["email"],0,5); ?>***********" readonly="">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php  echo substr($bilgi["telefon"],0,3); ?>*******" readonly="">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php if(isset($bilgi["username"])) { echo $bilgi["username"];}?>" readonly="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="rakeback" name="rakeback" disabled="disabled" value="<?php  echo $rakee;  ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
