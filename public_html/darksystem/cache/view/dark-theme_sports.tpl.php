            ...
            <div id="main-left" style="background: whitesmoke;" class="sidebar sidebar-left sidebar-animate sidebar-md-show nano">
                ...
                <div class="left-container nano-content">
                    ...
                    <div class="form-group form-icon">
                        ...
                        <input type="text" id="header_search_input" onkeyup="if (event.keyCode == 13){fnPreListBySearch();}" class="form-control" autocomplete="off" placeholder="Maç Ara" />
                                    ...
                                    <div class="subCategories live-sports async-menu all-events sub-sport-menu" id="live-menu" style="border:none;">
                                        ...
                                        <div class=" panel-default border-sm" style="border:none !important;">
                                            ...
                                            <div class="left_content CL-OP RND-OP" style="left: 0px;">
                                                ...
                                                <?php  include "content/dark-theme/view/bahisturmenu.php"; ?>
                ...
                <div class="center-container">
                    ...
                    <div class="content_center" id="content">
                        ...
                        <div id="interval-bets-container" class="bets no-padding-sm">
                            ...
                            <div id="match_<?php if(isset($i["id"])) { echo $i["id"];}?>" data-matchid="<?php if(isset($i["id"])) { echo $i["id"];}?>" data-datasource="1" class="CL-OP RND-OP match_list_row event" >
                                ...
                                <span class="right">
                                    ...
                                    <span class="iconDetails text" onclick="matchDetails(<?php if(isset($i['id'])) { echo $i['id'];}?>, this)"><i class="fa fa-plus-square" aria-hidden="true"></i></span>
