                ...
                <div class="center-container">
                    <div class="panel panel-white no-padding-sm">
                        <div class="panel-heading">
                            <h2><i class="icon-money-bag"></i> Para Çekme</h2>							
						</div>
                        ...
                        <div class="panel-group panel-collapse" id="acc-accordion">
                            <div class="panel panel-default">
                                        ...
                                        <div class="row bwt-details">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" disabled=""> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-footer">
                                        <a <a style="color:#1a2732;" href="#" target="_blank">BANKA HAVALESİ İLE ÇEKİM NASIL YAPILIR?</a>
                                ...
                                <div class="panel-collapse collapse" id="collapse2" aria-expanded="false" style="height: 0px;">
                                    ...
                                    <div class="panel-footer">
                                        <a <a style="color:#1a2732;" href="#" target="_blank">PAPARA İLE ÇEKİM NASIL YAPILIR?</a>
                                ...
                                <div class="panel-collapse collapse" id="collapse3" aria-expanded="false" style="height: 0px;">
                                    ...
                                    <div class="panel-footer">
                                        <a <a style="color:#1a2732;" href="#" target="_blank">PAYFİX İLE ÇEKİM NASIL YAPILIR?</a>
                                ...
                                <div class="panel-heading show collapsed" style="text-align: left;" data-toggle="collapse" data-parent="#acc-accordion" href="#collapse4" aria-expanded="false"> <img src="/images/footer_partners/payment/cmtc.png" class="withdrawico" >
                                    <h4>CMT CÜZDAN İLE PARA ÇEKME</h4> <i class="pull-right icon-arrow-down"></i> </div>
                                <div class="panel-collapse collapse" id="collapse4" aria-expanded="false" style="height: 0px;">
                                    ...
                                    <div class="panel-footer">
                                        <a <a style="color:#1a2732;" href="#" target="_blank">CMT CÜZDAN İLE ÇEKİM NASIL YAPILIR?</a>
                                ...
                                <div class="panel-heading show collapsed" style="text-align: left;" data-toggle="collapse" data-parent="#acc-accordion" href="#collapse6" aria-expanded="false"> <img src="/images/footer_partners/payment/btc.jpg" class="withdrawico" >
                                ...
                                <div class="panel-collapse collapse" id="collapse6" aria-expanded="false" style="height: 0px;">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label"> BTC Adresiniz <small></small> </label>
                                    ...
                                    <div class="panel-footer">
                                        <a <a style="color:#1a2732;" href="#" target="_blank">BEP20 Ağından BTC-BSC Adresinizi Giriniz.</a>
                                ...
                                <div class="panel-heading show collapsed" style="text-align: left;" data-toggle="collapse" data-parent="#acc-accordion" href="#collapse7" aria-expanded="false"> <img src="/images/footer_partners/payment/tether.jpg" class="withdrawico" >
                                ...
                                <div class="panel-collapse collapse" id="collapse7" aria-expanded="false" style="height: 0px;">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Tether Adresiniz <small></small> </label>
                                    ...
                                    <div class="panel-footer">
                                        <a <a style="color:#1a2732;" href="#" target="_blank">TRC20 Ağından USDT Adresinizi Giriniz.</a>
