                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="paparaibannamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="kartnamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="fastnamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="toslanamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="kriptonamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="paycellnamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="cepbanknamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="kassanamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="naysnamesurname" value="<?php if(isset($bilgi["name"])) { echo $bilgi["name"];}?>" type="text" readonly="">
